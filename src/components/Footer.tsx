    ...
    >
      ...
      >
        <div className="h-full w-full flex">
          <Link to={'/'} className="m-auto w-6 h-6" title="Back to home">
            <FontAwesomeIcon
              icon="home"
              className="w-full! h-full! text-grey hover:text-black dark:hover:text-dark-text"
            />
          </Link>
        </div>
      </div>
      ...
      >
        <a
          ...
          href={'https://www.linkedin.com/in/albert-pichler/'}
          target={'_blank'}
          rel={'noopener'}
        ...
        >
          <svg
            className={
              'w-7 h-7 text-grey hover:cursor-pointer fill-grey hover:fill-black dark:hover:fill-dark-text'
            }
            viewBox="0 0 72 72"
          >
            <g fillRule="evenodd">
